...
def admin (result, title = '', link = '', description = '', tags = [], category = '', img_path ='', body = '', post_id =''):
    ...
    extend_([u'             <p>tags:<br><input type="text" name="tags" size="100" value = "', escape_(' '.join(tags), True), u'"/> </p>\n'])
    ...
    extend_([u'             </p>\n'])
    extend_([u'             \n'])
    extend_([u'             <p>body :<br><textarea name="body" cols="100" rows="20">', escape_(body, True), u'</textarea></p>\n'])
...
def layout (content, title = None , tag_cloud = [], categories = [], navbar = True, posts_total_count = 0, admin = None):
    ...
    extend_([u'    <link rel="stylesheet" href="/stylesheets/uniform.default.css"/>\n'])
